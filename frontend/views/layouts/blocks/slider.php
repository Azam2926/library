            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide dark">
                    <div class="container-fluid h-100 p-5 p-lg-6">
                        <div class="slider-caption justify-content-end">
                            ...
                            <p class="my-4 text-smaller" data-animate="fadeInUp" data-delay="100">A New Collection of
                                Summer 2022.</p>
                            <div>
                ...
                <div class="swiper-slide dark">
                    <div class="container-fluid h-100 p-5 p-lg-6">
                        <div class="slider-caption justify-content-end">
                            ...
                            <p class="my-4 text-smaller" data-animate="fadeInUp" data-delay="100">Featured Collection of
                                2022.</p>
                            <div>
                                <a href="#" data-animate="fadeInUp" data-delay="200"
                                   class="button bg-color text-dark rounded-pill fw-normal">Shop Now</a>
                ...
                <div class="swiper-slide dark">
                    <div class="container-fluid h-100 p-5 p-lg-6">
                        <div class="slider-caption justify-content-end">
                            <h2 data-animate="fadeInUp">Brown Clay table Jar</h2>
                            <p class="my-4 text-smaller" data-animate="fadeInUp" data-delay="100">Latest Collection of
                                2022.</p>
                            <div>
                                <a href="#" data-animate="fadeInUp" data-delay="200"
                                   class="button bg-color text-dark rounded-pill fw-normal">Shop Now</a>
